...
import lawBuilding from "@/assets/placeholder_services.jpg";
...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        "Drawing on our senior team’s experience in consulting and commercial law, we deliver practical support across the transaction lifecycle. Our expertise covers debt management and recovery, insolvency, corporate restructuring, and financial advisory. We help clients manage risks, optimise outcomes, and achieve smooth deal execution."
    },
    {
      icon: FileText,
      title: "Labour & Employment Law",
      description:
        "In Nigeria’s dynamic economy, workplace arrangements continue to evolve with technology and globalisation. We advise employers and employees on employment contracts, workplace policies, and emerging labour issues. Our partners provide strategic guidance that balances compliance, fairness, and commercial practicality."
    },
    {
      icon: Users,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              We provide strategic legal solutions designed to resolve complex
              challenges efficiently, ethically, and with measurable results.
            </p>
          </div>
        </div>
      </section>
            ...
            {services.map((service, index) => {
              ...
              if (index === services.length - 1) {
                return (
                  <div
                    key={index}
                    className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch"
                  >
                    {/* Service Card */}
                    <Card className="p-8 hover:shadow-xl transition-all duration-300 animate-fade-in">
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
            ...
            challenges. Contact us today for a consultation.
          </p>
          <Link to="/contact">
